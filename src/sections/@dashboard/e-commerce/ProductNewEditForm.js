          ...
          <Card sx={{ p: 3 }}>
            <Stack spacing={3}>
              ...
              <div>
                ...
                <RHFEditor simple name="Descripcion" placeholder={'hello'} />
              </div>
          ...
          <Stack spacing={3}>
            <Card sx={{ p: 3 }}>
              ...
              <Stack spacing={3} mt={2}>
                <RHFTextField name="code" label="Reportado Por" />

                <RHFTextField name="sku" label="Encontrado En" />
